  ...
  '/more/react-hook/': [{
    ...
    children: [
      ['/more/react-hook/hook-all/', 'ReactHookAll'],
      {
        ...
        collapsable: false,
        children: [
          ['/more/react-hook/use-state/', 'useState'],
          ['/more/react-hook/use-effect/', 'useEffect'],
          ['/more/react-hook/use-ref/', 'useRef'],
          ['/more/react-hook/use-reducer/', 'useReducer'],
          ['/more/react-hook/use-callback/', 'useCallback'],
          ['/more/react-hook/use-memo/', 'useMemo'],
          ['/more/react-hook/use-context/', 'useContext'],
          ['/more/react-hook/force-update/', 'forceUpdate'],
        ]
      },
      {
        title: "customReactHook",
        collapsable: false,
        children: [
...
let sidebar_zh = {
  ...
  '/zh/more/react-hook/': [{
    ...
    children: [
      ['/zh/more/react-hook/hook-all/', 'ReactHook 导航'],
      {
        title: "reactHook",
        collapsable: false,
        children: [
          ['/zh/more/react-hook/use-state/', 'useState 数据存储'],
          ['/zh/more/react-hook/use-effect/', 'useEffect 副作用'],
          ['/zh/more/react-hook/use-ref/', 'useRef 获取元素dom'],
          ['/zh/more/react-hook/use-reducer/', 'useReducer 简易的redux'],
          ['/zh/more/react-hook/use-callback/', 'useCallback 类似vue Computed'],
          ['/zh/more/react-hook/use-memo/', 'useMemo 类似vue Computed'],
          ['/zh/more/react-hook/use-context/', 'useContext 数据共享容器'],
          ['/zh/more/react-hook/force-update/', 'forceUpdate 强制重新渲染'],
        ]
      },
      {
        title: "自定义 ReactHook",
